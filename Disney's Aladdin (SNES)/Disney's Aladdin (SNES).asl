state("Mesen-S", "0.4.4")
{
byte action: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0x9F;
byte demo: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0x345;
byte level: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0x35E;
byte screen: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0x35D;
byte reset: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0x8D;
byte cobra: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0xC0C;
byte cobra2: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0xC5C;
byte cobra3: "MesenSCore.dll", 0x4263DA8, 0x48, 0x5F0, 0x48, 0xCAC;
}
state("mednafen", "1.27.1") //RAM 0x00 == "mednafen.exe", 0x03FAFA48, 0x00;
{
    ...
    byte cobra3:"mednafen.exe", 0x03FAFA48, 0xCAC;
}
state("snes9x-x64") //RAM 0x00 == "snes9x-x64.exe", 0x8D8BE8, 0x00;
{
    ...
    byte cobra3:"snes9x-x64.exe", 0x8D8BE8, 0xCAC;
}
start
{
...
split
{
    ...
    if (current.level == 0x11)
    {
        ...
        if (old.cobra3 == 0x00 && current.cobra3 == 0xFF) return true;
    }
}
reset
{
