state("retroarch", "BlastEm") //RAM 0x00 == "blastem_libretro.dll", 0x172B18, 0x198, 0x00; Little endian!
{
    ...
    byte dead:"blastem_libretro.dll", 0x172B18, 0x198, 0xB9C0; //B9C1
    byte d:"blastem_libretro.dll", 0x172B18, 0x198, 0x6D19; //6D18
...
split
{
    ...
    if (current.screen == 0x9D && current.screen2 == 0x02 && current.lastboss <= 0x02 && current.dead == 0x32) return true;
}
reset
{
