...
{
    byte start:"MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x070;
    byte orb:"MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x13E8;
    byte hp_boss:"MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x13F6;
    byte stage:"MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x086;
    byte logo:"MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x032;
    byte time:"MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x076;
}
