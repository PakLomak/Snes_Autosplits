state ("Mesen-S") //RAM 0x00 == "MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x0;
{
    ...
    byte intro: "MesenSCore.dll", 0x04264020, 0x48, 0xFE8, 0x48, 0x2E0;
}
...
split
{
    ...
    else if (current.stage == 0x08 && current.loop == 0x00 && old.lastSplit == 0x00 && current.lastSplit == 0x04) return true;
